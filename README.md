...
The nf-core/arete pipeline comes with documentation about the pipeline [usage](https://nf-co.re/arete/usage), [parameters](https://nf-co.re/arete/parameters) and [output](https://nf-co.re/arete/output).
